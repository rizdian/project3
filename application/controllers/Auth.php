...
public function __construct()
    ...
    public function index()
    {
        ...
        } else if (!$this->ion_auth->in_group($this->su)) // remove this elseif if you want to enable this for non-admins
        {
    ...
    public function activate($id, $code = FALSE)
    {
        ...
        } else if ($this->ion_auth->in_group($this->su)) {
    ...
    {
        if (!$this->ion_auth->logged_in() || !$this->ion_auth->in_group($this->su)) {
            // redirect them to the home page because they must be an administrator to view this
...
//			$this->_render_page('auth/create_user', $this->data);
    ...
    {
        if (!$this->ion_auth->logged_in() || (!$this->ion_auth->in_group($this->su) && !($this->ion_auth->user()->row()->id == $id))) {
            redirect('auth', 'refresh');
        }
